...
function importForm() {
		...
		<TR>
			...
			<FONT COLOR="#336666"><B><?php echo _IMPORTCOURSE?></B></FONT>
			<BR><BR><?php echo _IMPORTDESC?>
			<BR><BR>
	...
	?>
			<TR>
				<TD><?php echo _COURSECODE?></TD><TD><INPUT TYPE="text" NAME="course_code" SIZE="8" VALUE="<?php echo $sscode?>"></TD>
			</TR>
			<TR>
				<TD><?php echo _PACKAGE?></TD><TD><INPUT TYPE="file" NAME="fileimport"></TD>
			</TR>
			<TR>
			<?php 
				$php_ini = ini_get_all();
			...
			?>
				<TD><?php echo _FILESIZE?></TD><TD><B><?php echo $upload_max_filesize["global_value"]; ?>B</B></TD>
			</TR>
			<TR>
				<TD>&nbsp;</TD>
				<TD><BR><INPUT TYPE="submit" VALUE="<?php echo _IMPORTCOURSE?>" class="button_org"></TD>
			</TR>
			</TABLE>
